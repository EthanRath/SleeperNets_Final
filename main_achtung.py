...
if __name__ == "__main__":
    ...
    with torch.device("cuda"):
        ...
        mm = None
        #mm = MiddleMan(poisoner, action_index, dist, p_rate = 0, p_steps = 1)
        #mm = DeterministicMiddleMan(poisoner, action_index, dist, 1000 * 1000 * 4, 4000)

        agent = PPO(policy_func, env,  save_tag = env_id + tag, timesteps_per_batch = 2, max_timesteps_per_episode = 1000,
                     bufferman = bm, continuous = False, gamma = .95, bs = 1000, lr = .0005, pixels = False, safety = True,
        ...
        frames, batch_obs, batch_acts, _, _, _, _ = agent.rollout(poison = False, plot = True)
        ...
        save_frames_as_gif(frames, "images/")
